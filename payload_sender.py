...
# Url and headers
url = "http://" + ip + "/centreon/api/events/"
...
# (Optional) Build monitored item to avoid empty fields and have only one line in payload
#if servicedesc:
...
log_file_name = "/var/log/centreon-engine/http_payload-log-" + datetime.datetime.today().strftime("%Y%m%d")
